...
int main(int argc, char *argv[]) {
    // Dataset Preparation
    uint16_t training_input_shape[] = {1200, 3};
    uint16_t training_target_shape[] = {1200, 3};
    ...
    ailayer_input_f32_t input_layer = AILAYER_INPUT_F32_A(3, input_layer_shape);

    ailayer_dense_f32_t dense_layer_1 = AILAYER_DENSE_F32_A(16);
    ailayer_relu_f32_t relu_layer_1 = AILAYER_SIGMOID_F32_A();

    ailayer_dense_f32_t dense_layer_2 = AILAYER_DENSE_F32_A(8);
    ...
    for (int i = 0; i < 30; i++) {
        aitensor_t input_tensor_testing = AITENSOR_2D_F32(input_shape_testing, (testing_features + i * 3));
